...
<div class="wrap hero">
  ...
  <p class="lede">I'm Dustin, the guy behind Felt Experience Poker. I've played online poker
     professionally since 2007, and currently play up to 2kNL. Every week I break down real hands
...
<div class="wrap">
  ...
  <div class="about">
    ...
    <div class="about-photo"><img src="/assets/dustin.jpg" width="150" height="150"
      loading="lazy" alt="Dustin Goldklang" /></div>
...
<div class="wrap">
  ...
  {tool("Intuitive Tables", "https://transactions.sendowl.com/stores/13446/331249", "Multi-tabling software with custom hotkeys, layouts, overlays, RNG, and timing tell data.", "Two week free trial")}
</div>
"""
